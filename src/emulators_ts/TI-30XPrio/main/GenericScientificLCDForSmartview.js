...
const _0x20d674 = require("../../../../src/emulators_ts/GenericLCDColumnMajor");
class GenericScientificLCDForSmartview extends _0x20d674.GenericLCDColumnMajor {
constructor(_0x384165, _0xaf46ab) {
	super(_0x384165, _0xaf46ab);
	this.lastPartialScreenDataBuffer = new Uint8Array(new ArrayBuffer(1536));
	this.lastPartialTopIconsBuffer = new Uint8Array(new ArrayBuffer(0xc0));
	this.completeScreenBuffer = new Uint8Array(new ArrayBuffer(1728));
	this.refreshTimerInterval = 0x2a;
...
["buildAllScreenBufferColumnMajor"]() {
	...
	if (_0x8dc01f && _0x1ce525) {
		...
		for (let _0x17eb0d = 0x1; _0x17eb0d < 1728; _0x17eb0d++) {
			if (_0x17eb0d % 9 === 0) {
