...
const keypad = require("../../../../../../src/emulators_ts/TI-30XPro/main/TI30XProKeypad");
const svg = require("./TI30XProSVG");
const utilities = require("../../../../../../src/emulators_ts/Utilities");
class TI30XProSmartviewKeypad extends keypad.TI30XProKeypad {
	start() {
		return new Promise((resolve, reject) => {
			let docelement;
			let viewbox;
			const domparser = new DOMParser();
			const parsedxml = domparser.parseFromString(svg.TI30XProSVG, "text/xml");
...
exports.TI30XProSmartviewKeypad = TI30XProSmartviewKeypad;
